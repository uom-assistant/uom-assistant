...
<i18n>
{
    ...
    "ja": {
        ...
        "welcome": "ようこそ！",
        "not_yet": "UoMアシスタントはまだ設定されないようです..",
        ...
        "clock": "時計",
        "bblinks": "クイックリンク",
        "livelinks": "オンライン授業のリンク",
        "done": "完成",
        "account_notice_title": "アカウント情報はまだ設定されません",
        "account_notice_body": "大学アカウントは設定されていません、これにより、成績、出勤統計及びメールのウィジェットは利用できないになります。続けでもよろしいですか？",
        "cancel": "キャンセル",
        "setup_done": "おめでとう！UoMアシスタントは設定完了しており、利用可能になりました。さって、「クイックノート」で「UoMAユーザーガイド」というノートを見つかれる。このノートはUoMアシスタントの機能を簡単に紹介しており、このノートを通じてUoMアシスタントの使用を上手になることができます。UoMAコンミュニティの支援者のおかげで、いま「プラグイン」ウィジェットの\"Course Info Importer\"プラグインで自分に対応する学年を検索してと、手動にモジュール情報の輸入は必要ない。もっと詳細については、<ahref=\"https://github.com/uom-assistant/uom-assistant\"target=\"_blank\"rel=\"noopenernofollow\">GitHub</a>を参照してください。",
        "network_error": "",
        "backend_error": "",
        "backend_maintenance": "",
        "token_required": "",
