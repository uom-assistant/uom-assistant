...
<i18n>
{
    ...
    "ja": {
        ...
        "network_error_body": "バックエンドからメール関する情報が取得できませ。",
        "cannot_download": "バックエンドから添付ファイルがダウンロードされできませ。",
        "learn_more": "もっと詳しく",
        "md_support": "Markdownをサポート",
        "view": "プレビュー",
        "edit": "編集",
        "write": "作成",
        "refresh": "リフレッシュ",
        ...
        "delete": "メールを削除する",
        "more_mail": "最近二週間のメールを表示するだけ、他のメールを見るには、{0} にアクセスしてください。",
        "me": "自分",
        "from": "送信者",
        "to": "宛先",
        "cc": "CC",
        "time": "時間",
        "trusted_sender": "信憑性高い的な送信者です",
        "internal_sender": "マンチェスター大学の内部の送信者から",
        "unsafe_content": "このメールはマンチェスター大学の外部の不明送信者からにもらいました、テキストモードで表示されています。",
        ...
        "add_attachment": "クリックやドラッグして添付ファイルを追加",
        ...
        "translation_tip": "メール翻訳機能を有効にすると、メールが翻訳可能の時に翻訳パネルが表示されます。メールの翻訳機能は、第三者の翻訳サービスに内容を送信する必要があります。この翻訳を利用すると、このサービスの利用規約に同意したことになります。具体的な翻訳サービス会社は、翻訳パネルの左下に表示されます。",
        "language_unsupported_tip": "バックエンドが提供する翻訳サービスが、この言語が支援されない可能性があります。こんな時に、翻訳パネルがひょうじされません。",
        "language_tip": "原文の言語と訳文の言語が違いの時だけに、翻訳パネルが表示されます。メールの言語を検出することはローカルで自動的に実行します。",
        "cancel": "キャンセル",
        "save": "保存",
        "powered_by": "{0} で翻訳されました",
        "enable_translate": "翻訳機能を有効化する",
        "translate": "翻訳",
        "source": "原文",
        "in_language": "このメールは{0}で書かれているようです",
