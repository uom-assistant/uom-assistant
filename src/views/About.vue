...
<i18n>
{
    ...
    "ja": {
        ...
        "about_2": "UoMアシスタントはオープンソースですから、ご自由に利用する、私たちに意見を出してくれるください。自分のサーバーで配備する、ソースコードを編集することはも許可されています。私たちに協力してくれるも歓迎します。",
        "about_3": "UoMアシスタントプロジェクトは、Axton Yao氏によって開始された、そしてAxton Yao氏と他の貢献者によって共に開発されました。もっとしりたいと思ったら、私たちのGitHubページ又は公式サイトをアクセスしてください。",
        "author": "著者",
        "contributors": "貢献者",
