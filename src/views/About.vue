...
export default {
    ...
    methods: {
        ...
        async loadbackendVersion() {
            ...
            this.backendVersion = (await betterFetch(`https://${this.backend.url}/check_ability/`, {}, this.backend.url.length).catch(() => ({ uomabVersion: 'unknown' }))).uomabVersion || 'unknown';
        },
        /**
...
<i18n>
{
    ...
    "ja": {
        "title": "UoMアシスタント",
        "learn_more": "もっと詳しく",
        "about_1": "UoMアシスタントは、あなたのマンチェスター大学での学習に役立つWebアプリケーションです。すべて必要な情報は、あなたの目の届くところにあります。",
        "about_2": "UoMアシスタントはオープンソースですから、ご自由に利用したり、私たちに提案したり、自分のサーバーでバックエンドを管理したり、自分の思い通りにソースコードを修正したりすることが許可されています。私たちの開発に協力してくれることはも歓迎します。",
        "about_3": "UoMアシスタントプロジェクトは、Axton Yao氏によって開始された、そしてAxton Yao氏と他の貢献者によって共に開発されました。もっと知りたいと思ったら、私たちのGitHubページや公式サイトをアクセスしてください。",
        "author": "著者",
        "contributors": "貢献者",
