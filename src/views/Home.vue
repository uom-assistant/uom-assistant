...
<i18n>
{
    ...
    {
        "overview": "今日の概要",
        "class_overview": "今日は授業がありない | 今日は {0} つの授業がある | 今日は {0} つの授業がある",
        "class_remian": "，まだ {0} つ残ってる",
        "class_remian_none": "。",
        "tomorrow_first": "明日の最初の授業は {0} に始まります。",
        "tomorrow_first_none": "明日は授業がありない。",
        "tomorrow_first_none_rest": "明日は授業がありない、ちょっと休みましょう",
        "next": "次の授業 {0}",
        ...
        "no_course_checkin": "チェックインが必要な授業はありない。",
        "and": "と",
