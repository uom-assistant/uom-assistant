...
<i18n>
{
    ...
    "ja": {
        ...
        "auto_dark_mode_text": "UoMアシスタントのインタフェーステーマをシステム設定に応じて自動的に切り替えます。",
        "save": "保存",
        ...
        "import": "インポート",
        "reset": "リセット",
        "data_settings_text": "現在の設定をエクスポートし、別のデバイスにインポートできます。",
        "clear_text": "ブラウザーに保存されているすべてのデータをクリアし、UoMアシスタントを完全にリセットします。",
        ...
        "ok": "はい",
        "blur_mode": "アクリルブラー",
        "blur_mode_text": "アクリルスタイルのブラーを有効にします。",
        "sync_settings": "同期設定",
        "sync_settings_text": "Todoist APIを利用して、コースリストとタスクリストをデバイス間で同期できます。",
        "connected": "接続済み",
        "connect_todoist": "Todoistに接続",
        "connect": "接続",
        "cancel": "キャンセル",
        "choose_project": "",
        "init_sync_direction": "",
        ...
        "used": "{0} を使用中",
        "used_item": "{0} つのアイテム、{1} を使用中 | {0} つのアイテム、{1} を使用中",
        "total": "{0} 使用可能",
        "db": "データベース",
        "cache": "キャッシュ",
        "cache_manage": "キャッシュ管理",
        "about_storage": "ストレージについて",
        "about_storage_text": "この数値は、使用可能なストレージ容量の推定値です、正確な値ではない。そのため、実際の使用可能容量は、この数値と少し異なる可能性があります。",
        "persisted_stroage_on": "持続記憶ストレージは有効です",
        "persisted_stroage_off": "持続記憶ストレージは無効です",
        "persisted_stroage_text": "持続記憶ストレージを有効にすると、ブラウザーはUoMアシスタントのデータを自動的に削除しません。",
        "persisted_stroage_text_on": "ディスク容量不足てもブラウザーはUoMアシスタントのデータを自動的に削除しません。",
        "persist_stroage": "持続記憶ストレージ",
        "persist_stroage_text": "",
        "continue": "続行",
        "persist_stroage_unsupported": "このブラウザーは持続記憶ストレージの機能をサポートしていません。",
        "reset_dialog": "UoMアシスタントをリセットする",
        "reset_dialog_body": "この操作は、UoMアシスタントのすべてのデータを削除し、アプリケーションを初期状態に戻します。"
    }
}
</i18n>
